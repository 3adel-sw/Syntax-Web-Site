  ...
  return (
    <div>
        ...
        <div className="bg-primary rounded-3xl p-9 text-center mb-5 md:my-10">
          ...
          <div className="flex md:flex-row flex-col items-center justify-center gap-2 md:max-w-lg mx-auto">
            <input
              type="email" placeholder="Your E-Mail"
              className="md:flex-1 w-full mb-2 bg-white rounded-xl px-4 py-3  text-sm outline-none border-none"
            />
