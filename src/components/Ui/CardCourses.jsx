...
const CourseCard = ({ course, navigate }) => {
  ...
  return (
    <div
     ...
     className="bg-white rounded-2xl my-4 border h-fil border-gray-200 p-2 overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-300 cursor-pointer"
  >
